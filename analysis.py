...
def analysis(ref):
    ...
    if not run.start.get("PTA") and not (run.start.get("md") and run.start.get("md").get("PTA")):
        ...
        protocols = [
            ...
            Protocols.linecut_qz_fit(name='linecut_qz_fit_p', qr=0.0195, dq=0.004, show_region=True, label_filename=True, trim_range=[0, 0.06], fit_range=[0.02, 0.055], plot_range=[0, 0.06, 0, None], q0=0.043, sigma=0.0022, critical_angle_substrate=0.132, critical_angle_film=0.094, ),
